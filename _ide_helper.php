...
namespace JellyBool\Translug { 
    ...
    class TranslugFacade {
        ...
        {
            return \JellyBool\Translug\Translation::translate($text);
        }
         ...
         * @static 
         */ 
        public static function translug($text)
        {
            return \JellyBool\Translug\Translation::translug($text);
        }
...
namespace  { 
    ...
    class Translug extends \JellyBool\Translug\TranslugFacade {}
